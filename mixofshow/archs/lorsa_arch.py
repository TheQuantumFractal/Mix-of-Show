...
from mixofshow.archs.lora_override import LoRSALinearLayer, lora_moved
...
class LoRSA(Stable_Diffusion):
                ...
                if module.__class__.__name__ == where:
                    for child_name, child_module in module.named_modules():
                        if child_module.__class__.__name__ == 'Linear':
                            lora_module = LoRSALinearLayer(name + '.' + child_name + '_lora', child_module,
    ...
    def forward(self, images, prompts, masks):
        ...
        return loss, self.get_l1(), self.get_nonzeros()
