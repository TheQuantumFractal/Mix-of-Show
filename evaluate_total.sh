...
device=1
for filename in /home/sarafk/Mix-of-Show/experiments/*/visualization/PromptDataset/Iters-latest_Alpha-1.0;
do
...
device=0
for filename in /home/sarafk/Mix-of-Show/experiments/*/models/*.pth;
do
